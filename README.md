A free project file that contains the whole pipeline to making a blob tracking video with unlimited blobs, given that the free version of TouchDesigner limits users to only two.
